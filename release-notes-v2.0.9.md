...
## Highlights
- **Publish Format Gate Restored**: repo-wide Prettier checks pass again for tracked OntoIndex sources, and donor material under `tmp/` is excluded from release-time formatting validation.
