DEBUG_ENV_VAR = "ONTOINDEX_EVAL_DEBUG"

# OntoIndex eval-server health checks
EVAL_SERVER_HEALTH_RETRIES = 30
EVAL_SERVER_HEALTH_INTERVAL_SECONDS = 0.5
EVAL_SERVER_HEALTH_TIMEOUT_SECONDS = 3

# MCP bridge timeouts
MCP_FIND_ONTOINDEX_TIMEOUT_SECONDS = 15
MCP_FIND_ONTOINDEX_FALLBACK_TIMEOUT_SECONDS = 10
