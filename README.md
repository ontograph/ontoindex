...
| Use a local downloaded tarball | `ONTOINDEX_LOCAL_ASSET="$PWD/ontoindex-2.1.1.tgz" ./scripts/install-ontoindex-latest.sh` | — |
...
| Platform           | Command                                                    |
| ------------------ | ---------------------------------------------------------- |
| Linux/macOS        | `npm install -g ontoindex@2.1.1 && ontoindex --version`   |
| Windows PowerShell | `npm.cmd install -g ontoindex@2.1.1; ontoindex --version` |
...
| Platform           | Command                                                                                                                         |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| Linux/macOS        | `npm install -g https://github.com/ontograph/ontoindex/releases/download/v2.1.1/ontoindex-2.1.1.tgz && ontoindex --version`   |
| Windows PowerShell | `npm.cmd install -g https://github.com/ontograph/ontoindex/releases/download/v2.1.1/ontoindex-2.1.1.tgz; ontoindex --version` |
...
| Image                                    | Purpose                                        |
| ---------------------------------------- | ---------------------------------------------- |
| `ghcr.io/ontograph/ontoindex:2.1.1`     | CLI, MCP server, and `ontoindex serve` backend |
| `ghcr.io/ontograph/ontoindex-web:2.1.1` | Web UI                                         |
