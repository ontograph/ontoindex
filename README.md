...
| Use a local downloaded tarball | `ONTOINDEX_LOCAL_ASSET="$PWD/ontoindex-2.0.4.tgz" ./scripts/install-ontoindex-latest.sh` | — |
...
| Image                                    | Purpose                                        |
| ---------------------------------------- | ---------------------------------------------- |
| `ghcr.io/ontograph/ontoindex:2.0.4`     | CLI, MCP server, and `ontoindex serve` backend |
