...
| Platform           | Command                                                    |
| ------------------ | ---------------------------------------------------------- |
| Linux/macOS        | `npm install -g ontoindex@1.9.24 && ontoindex --version`   |
| Windows PowerShell | `npm.cmd install -g ontoindex@1.9.24; ontoindex --version` |
...
| Platform           | Command                                                                                                                         |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
| Linux/macOS        | `npm install -g https://github.com/ontograph/ontoindex/releases/download/v1.9.24/ontoindex-1.9.24.tgz && ontoindex --version`   |
| Windows PowerShell | `npm.cmd install -g https://github.com/ontograph/ontoindex/releases/download/v1.9.24/ontoindex-1.9.24.tgz; ontoindex --version` |
...
| Image                                    | Purpose                                        |
| ---------------------------------------- | ---------------------------------------------- |
| `ghcr.io/ontograph/ontoindex:1.9.24`     | CLI, MCP server, and `ontoindex serve` backend |
| `ghcr.io/ontograph/ontoindex-web:1.9.24` | Web UI                                         |
