 ...
 *
 * Tests `ontoindex analyze --skills` across 11 supported languages plus
...
const SKILLS_E2E_CLI_TIMEOUT_MS = 45000;
const SKILLS_E2E_TEST_TIMEOUT_MS = 90000;
const SKILLS_E2E_IDEMPOTENCY_HOOK_TIMEOUT_MS = 150000;
 ...
 */
function runSkillsCli(cwd: string, timeoutMs = SKILLS_E2E_CLI_TIMEOUT_MS) {
...
function assertSkillFiles(
  ...
  expect(fs.existsSync(path.join(tmpDir, '.ontoindex'))).toBe(true);
...
`,
  ...
  }, SKILLS_E2E_IDEMPOTENCY_HOOK_TIMEOUT_MS);
