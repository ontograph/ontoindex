// ontoindex/src/core/ingestion/method-extractors/configs/swift.ts
// Verified against tree-sitter-swift 0.6.0
// ontoindex:keep — all helper functions in this file are assigned into the
// exported swiftMethodConfig (MethodExtractionConfig) object and are called
// via the config interface at runtime. They appear unreached to static
// dead-code analysis because they are passed as function-valued properties.
...
export const swiftMethodConfig: MethodExtractionConfig = {
  ...
  // Verified against tree-sitter-swift 0.6.0 on Node 22: struct, enum, extension, and actor
  // declarations all parse as class_declaration — there are no distinct struct_declaration,
  // enum_declaration, extension_declaration, or actor_declaration node types in this grammar.
  // protocol_declaration is a separate, confirmed node type.
  typeDeclarationNodes: ['class_declaration', 'protocol_declaration'],

  // function_declaration for class/struct/extension/actor methods,
  // protocol_function_declaration for protocol methods
  methodNodeTypes: ['function_declaration', 'protocol_function_declaration'],

  // enum bodies use enum_class_body; all other type bodies use class_body
  bodyNodeTypes: ['class_body', 'enum_class_body', 'protocol_body'],
