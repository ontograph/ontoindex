 ...
 * lives in `ontoindex-shared` (finalize algorithm #915, the four per-file
 ...
 */
interface FinalizeOrchestratorOptions {
  /**
...
export function finalizeScopeModel(
  ...
  // in ontoindex-shared already encapsulate (first-write-wins, qname
