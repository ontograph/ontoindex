...
CREATE REL TABLE ${REL_TABLE_NAME} (
  ...
  FROM Concept TO CodeElement,
  FROM Concept TO \`Struct\`,
  FROM Concept TO \`Enum\`,
  FROM Concept TO \`Macro\`,
  FROM Concept TO \`Typedef\`,
  FROM Concept TO \`Union\`,
  FROM Concept TO \`Namespace\`,
  FROM Concept TO \`Trait\`,
  FROM Concept TO \`Impl\`,
  FROM Concept TO \`TypeAlias\`,
  FROM Concept TO \`Const\`,
  FROM Concept TO \`Static\`,
  FROM Concept TO \`Variable\`,
  FROM Concept TO \`Property\`,
  FROM Concept TO \`Record\`,
  FROM Concept TO \`Delegate\`,
  FROM Concept TO \`Annotation\`,
  FROM Concept TO \`Constructor\`,
