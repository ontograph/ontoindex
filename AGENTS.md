...
This project is indexed by OntoIndex as **ontoindex** (38264 symbols, 56855 relationships, 300 execution flows). Use the OntoIndex MCP tools to understand code, assess impact, and navigate safely.
