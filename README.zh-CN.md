...
| 使用本地下载的 tarball | `ONTOINDEX_LOCAL_ASSET="$PWD/ontoindex-2.1.3.tgz" ./scripts/install-ontoindex-latest.sh` | — |
...
| Image | 用途 |
| --- | --- |
| `ghcr.io/ontograph/ontoindex:2.1.3` | CLI、MCP server 和 `ontoindex serve` backend |
