...
| Локальный скачанный tarball | `ONTOINDEX_LOCAL_ASSET="$PWD/ontoindex-2.0.1.tgz" ./scripts/install-ontoindex-latest.sh` | — |
...
| Image | Назначение |
| --- | --- |
| `ghcr.io/ontograph/ontoindex:2.0.1` | CLI, MCP server и `ontoindex serve` backend |
