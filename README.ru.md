...
| Локальный скачанный tarball | `ONTOINDEX_LOCAL_ASSET="$PWD/ontoindex-2.1.2.tgz" ./scripts/install-ontoindex-latest.sh` | — |
...
| Image | Назначение |
| --- | --- |
| `ghcr.io/ontograph/ontoindex:2.1.2` | CLI, MCP server и `ontoindex serve` backend |
