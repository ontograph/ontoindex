...
| Локальный скачанный tarball | `ONTOINDEX_LOCAL_ASSET="$PWD/ontoindex-2.0.7.tgz" ./scripts/install-ontoindex-latest.sh` | — |
...
| Платформа | Команда |
| --- | --- |
| Linux/macOS | `npm install -g ontoindex@2.0.6 && ontoindex --version` |
| Windows PowerShell | `npm.cmd install -g ontoindex@2.0.6; ontoindex --version` |
...
| Image | Назначение |
| --- | --- |
| `ghcr.io/ontograph/ontoindex:2.0.6` | CLI, MCP server и `ontoindex serve` backend |
| `ghcr.io/ontograph/ontoindex-web:2.0.6` | Web UI |
